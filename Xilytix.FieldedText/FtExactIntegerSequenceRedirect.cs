...
{
    public class FtExactIntegerSequenceRedirect: FtSequenceRedirect
    {
        public new const int Type = FtStandardSequenceRedirectType.ExactInteger;

        private long value;

        internal protected FtExactIntegerSequenceRedirect(int myIndex) : base(myIndex, Type) { }
        ...
        internal override bool CheckTriggered(FtField field)
        {
            ...
            else
            {
                try
                {
                    return field.AsRedirectInteger == value;
                }
        ...
        internal protected override void LoadMeta(FtMetaSequenceRedirect metaSequenceRedirect, FtMetaSequenceList metaSequenceList, FtSequenceList sequenceList)
        {
            ...
            FtExactIntegerMetaSequenceRedirect integerMetaRedirect = metaSequenceRedirect as FtExactIntegerMetaSequenceRedirect;
            value = integerMetaRedirect.Value;
        }
    }
}
